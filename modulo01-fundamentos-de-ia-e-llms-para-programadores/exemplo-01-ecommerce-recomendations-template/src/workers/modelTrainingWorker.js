...
// Pesos para cada feature (ajustável para dar mais importância a certas características)
const WEIGHTS = {
  category: 0.4,
  color: 0.3,
  price: 0.2,
...
function makeContext(products, users) {
  ...
  // Normalizar a média de idade para 0–1
...
// One-hot encoding com peso: transforma categoria/cor em vetor binário e aplica peso
// Exemplo: category=“Eletrônicos”, categories=[“Roupas”, “Eletrônicos”, “Casa”], weight=0.4
// → [0, 0.4, 0]
const oneHotWeighted = (index, length, weight) => tf.oneHot(index, length).cast('float32').mul(weight);

// Combina todas as features do produto em um único vetor
...
// Para cada usuário, calcular a média dos vetores dos produtos comprados
...
// Criar dados de treinamento combinando cada usuário com cada produto
...
// Treinar um modelo simples de rede neural para prever se um usuário compraria um produto
